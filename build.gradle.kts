...
subprojects {
    ...
    val jsoupVersion = "1.20.1" // https://mvnrepository.com/artifact/org.jsoup/jsoup
    ...
    val quarkusVersion = "3.24.1" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
