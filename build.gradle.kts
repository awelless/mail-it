...
subprojects {
    ...
    val jsoupVersion = "1.18.1" // https://mvnrepository.com/artifact/org.jsoup/jsoup
    ...
    val quarkusVersion = "3.12.2" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
