...
subprojects {
    ...
    val quarkusVersion = "3.21.4" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
    ...
    val mockkVersion = "1.14.0" // https://mvnrepository.com/artifact/io.mockk/mockk
