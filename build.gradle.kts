...
subprojects {
    ...
    val freemarkerVersion = "2.3.33" // https://mvnrepository.com/artifact/org.freemarker/freemarker
    val jsoupVersion = "1.17.2" // https://mvnrepository.com/artifact/org.jsoup/jsoup
    val kotlinLoggingVersion = "3.0.5" // https://mvnrepository.com/artifact/io.github.microutils/kotlin-logging
    val kryoVersion = "5.6.0" // https://mvnrepository.com/artifact/com.esotericsoftware/kryo
    val quarkusVersion = "3.11.1" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
