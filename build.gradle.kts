...
subprojects {
    ...
    val quarkusVersion = "3.17.6" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
    ...
    val mockkVersion = "1.13.16" // https://mvnrepository.com/artifact/io.mockk/mockk
