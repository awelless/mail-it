...
subprojects {
    ...
    val kryoVersion = "5.6.1" // https://mvnrepository.com/artifact/com.esotericsoftware/kryo
    val quarkusVersion = "3.15.1" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
