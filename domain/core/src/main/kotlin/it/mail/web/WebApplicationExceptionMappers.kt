...
@Provider
class ValidationExceptionMapper : ExceptionMapper<it.mail.domain.core.ValidationException> {

    override fun toResponse(exception: it.mail.domain.core.ValidationException): Response =
...
@Provider
class NotFoundExceptionMapper : ExceptionMapper<it.mail.domain.core.NotFoundException> {

    override fun toResponse(exception: it.mail.domain.core.NotFoundException): Response =
