pluginManagement {
    ...
    val ktlintVersion = "11.2.0" // https://mvnrepository.com/artifact/org.jlleitschuh.gradle/ktlint-gradle
    ...
    val quarkusVersion = "2.16.2.Final" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
