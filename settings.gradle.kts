pluginManagement {
    ...
    val kotlinVersion = "1.9.20" // https://mvnrepository.com/artifact/org.jetbrains.kotlin/kotlin-stdlib
    ...
    val quarkusVersion = "3.5.0" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
