pluginManagement {
    ...
    val ktlintVersion = "11.6.0" // https://mvnrepository.com/artifact/org.jlleitschuh.gradle/ktlint-gradle
    ...
    val quarkusVersion = "3.4.3" // https://mvnrepository.com/artifact/io.quarkus.platform/quarkus-bom
