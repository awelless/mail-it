pluginManagement {
    ...
    val kotlinVersion = "1.8.22" // https://mvnrepository.com/artifact/org.jetbrains.kotlin/kotlin-stdlib
    val ktlintVersion = "11.4.2" // https://mvnrepository.com/artifact/org.jlleitschuh.gradle/ktlint-gradle
